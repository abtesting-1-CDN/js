/* Version: A_01 - 17.01. 2023 - 00:01:51 */
...
div.setAttribute("id", "id_kts_A_25");
document.querySelector("#regexDivId").insertAdjacentElement("afterend", div);
    
console.log("imab push id_kts_A: id_kts_A_25 name: id 19");
document.querySelector("#id_kts_A_25").innerHTML = "test 25%(id 22)";
